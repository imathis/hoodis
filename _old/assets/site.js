...
(function() {
  ...
  $.fn = _.extend($.fn, {
    ...
    orAttr: function(property, value) {
    ...
    hideAfter: function(time, onComplete) {
      if (time == null) {
        time = 400;
      }
      if (onComplete == null) {
      ...
      return this.addClassAfter('hide', time, onComplete);
    },
    showUntil: function(time, onComplete) {
      if (time == null) {
        time = 400;
      }
      if (onComplete == null) {
  ...
  }, fadeOut = function(time, className, onComplete) {
    if (time == null) {
      time = 400;
    }
    if (className == null) {
    ...
    this.addClassUntil(className, time);
    return this.addClassAfter('hide', time, onComplete);
  }, {
    toggleStyle: function(property, value, condition) {
      if (condition == null) {
        condition = true;
      }
    ...
    fillHeight: function(condition) {
      if (condition == null) {
        condition = true;
      }
      return this.toggleStyle('min-height', $(window).height() - this.offset().top, condition);
    },
    optionHash: function() {
      var o, opt, _i, _len, _ref;
      opt = {};
      _ref = this.find('option');
...
(function() {
  ...
  _.mixin({
    ...
    delay: function(wait, func) {
      ...
      return this.delay_(func, wait, arguments);
    },
    ...
    debounce: function(wait, func) {
      ...
      return this.debounce_(func, wait, arguments);
    },
    ...
    throttle: function(wait, func) {
      ...
      return this.throttle_(func, wait, arguments);
    },
    trim: function(array) {
    ...
    splitTrim: function(s, trimOn) {
      if (trimOn == null) {
        trimOn = ',';
      }
      return this.compact(this.trim(s.split(trimOn)));
    }
  });
...
(function() {
  ...
  Questions = (function(_super) {
    ...
    function Questions() {
      this.parseQuestions = __bind(this.parseQuestions, this);
    ...
    Questions.prototype.initialize = function(options) {
      ...
      return this.fetch({
        error: function(model, response, options) {
          var qs;
          qs = _this.parseQuestions(response.responseText);
  ...
  Test = (function(_super) {
    ...
    Test.prototype.closeQuestion = function(e) {
      var q;
      q = $(e.currentTarget);
      return q.toggleClass('show');
    };
